...
export async function GET(request: NextRequest): Promise<NextResponse> {
  ...
  const statusMetrics = sanitizeExecutionMetrics({
    ...
    sortino_ratio: statusData.sortino_ratio,
    calmar_ratio: statusData.calmar_ratio,
    profit_factor: statusData.profit_factor,
    alpha_retention: statusData.alpha_retention,
